...
class FireReader():
    ...
    def smallest_fire(self):
        ...
        return sorted(self.data_dict['area'])[0]
    ...
    def most_fires_month(self):
        ...
        return f"The month with the most fires was" {top_month}
    ...
    def temp_of_smallest(self):
        ...
        smallest_area = self.smallest_fire
        data_index = self.data_dict['area'].index(smallest_area)\
